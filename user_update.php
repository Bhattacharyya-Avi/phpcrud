<?php
include 'connect.php';
# receiving id from the url
$id = $_GET['userID'];
# geting old data for that id
$sql = "select * from `user` where id=$id";
$result = mysqli_query($con,$sql);
$row = mysqli_fetch_assoc($result); # storing data for that data in array formate
# storing particular data to particular variable
$name=$row['name'];
$email=$row['email'];
...
if (isset($_POST['submit'])) {
  ...
  #mysql query
  $sql = "update `user` set id=$id, name='$name',email='$email',password='$password',address='$address'";
    ...
    <div class="col-lg-8 my-5">
      ...
      <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input name="password" type="password" class="form-control" id="exampleInputPassword1" value="<?php echo $password; ?>">
        </div>
        <div class="mb-3">
